...
1. Save to `./Notes/` directory with descriptive names
...
- The last piece of your response should be two things.
  ...
  - A path to the generated HTML file, e.g. `./Notes/cc_genui_<concise description>_YYYYMMDD_HHMMSS.html`.
