...
Invoke the Skill tool with `skill: "sync-claude-config"` and pass the arguments through: `$ARGUMENTS`

If no host was given, discover candidates from ~/.ssh/config per the skill's §0 and ask which to sync.
